...
for file in os.listdir(directory):
    ...
    # client = QdrantClient(url=os.getenv("f_URL"), api_key=os.getenv("QDRANT_API_KEY"))
    qdrant_client = QdrantClient(
    url="https://c0206c48-98fa-4807-8ee4-f3dfcd64d748.sa-east-1-0.aws.cloud.qdrant.io:6333", 
    api_key="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhY2Nlc3MiOiJtIiwiZXhwIjoxNzcyMjg4NTk0fQ.zltm7amQdNnn5fw6bWHtUYUxEG22APusEk3NxVC79BM",
)
    client
